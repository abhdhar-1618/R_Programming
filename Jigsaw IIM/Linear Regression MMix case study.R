...
setwd("D:/Jigsaw Jitendra/IPBA/Training/Stats Modeling/Linear Regression")
...
mmix$PromoType[is.na(PromoType)] <- "NO_OFFER"
...
names(mmix)
#Iteration 2
Mulreg<-lm(NewVolSales~BasePrice+PromoType+Radio+TV+InStore+Facebook+Twitter
           + WebCamp + Inserts,data=mmix)
#Mulreg
summary(Mulreg)
